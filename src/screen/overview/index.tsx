...
const s = StyleSheet.create({
  ...
  panelTitle: { fontSize:13, fontWeight:'700', color:'#333', letterSpacing:0.3 },
  panelActions: { flexDirection:'row', alignItems:'center', gap:4 },
  actTxt: { fontSize:13, color:'#1976D2', fontWeight:'600' },
  actDot: { fontSize:13, color:'#ccc' },

  /* group chips */
  chipWrap: { flexDirection:'row', flexWrap:'wrap', paddingHorizontal:10, gap:8 },
  chip: {
    flexDirection:'row', alignItems:'center',
    paddingVertical:7, paddingHorizontal:12,
    borderRadius:20, borderWidth:1.5, borderColor:'#D0D0D0',
    backgroundColor:'#F7F7F7',
  },
  chipOn:    { borderColor:'#1976D2', backgroundColor:'#E3F2FD' },
  chipDot:   { fontSize:12, color:'#1976D2', fontWeight:'bold' },
  chipTxt:   { fontSize:13, color:'#555' },
  chipTxtOn: { color:'#1565C0', fontWeight:'700' },

  divider: { height:1, backgroundColor:'#F0F0F0', marginVertical:10, marginHorizontal:14 },

  /* command chips */
  cmdWrap: { flexDirection:'row', alignItems:'center', flexWrap:'wrap', paddingHorizontal:14, gap:8 },
  cmdHint: { fontSize:12, color:'#aaa' },
  cmdChip: {
    flexDirection:'row', alignItems:'center',
  ...
  cmdDot:    { fontSize:12, color:'#C62828', fontWeight:'bold' },
  cmdTxt:    { fontSize:13, color:'#555' },
  ...
  thead: { flexDirection:'row', backgroundColor:'#263238', paddingVertical:8, paddingHorizontal:12 },
  th:    { color:'#fff', fontSize:12, fontWeight:'700' },
  tr:    { flexDirection:'row', alignItems:'center', borderBottomWidth:1, borderColor:'#F5F5F5', minHeight:50, paddingHorizontal:12, paddingVertical:6 },
  tLbl:  { flex:1.1, fontSize:13, color:'#444', paddingRight:6 },
  tIn:   { flex:1, height:38, borderWidth:1, borderColor:'#E0E0E0', borderRadius:6, paddingHorizontal:10, fontSize:13, color:'#222', backgroundColor:'#FAFAFA' },
  tRO:   { backgroundColor:'#F5F5F5', color:'#999', borderColor:'#EEE' },
  radRow:{ flex:1, flexDirection:'row', flexWrap:'wrap', paddingVertical:5, gap:8 },

  nowBtn: { paddingHorizontal:9, paddingVertical:5, borderRadius:6, borderWidth:1.5, borderColor:'#1976D2' },
